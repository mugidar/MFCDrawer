...
// MFCDrawer.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCDrawerApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCDrawerApp::OnAppAbout)
...
// Создание CMFCDrawerApp

CMFCDrawerApp::CMFCDrawerApp() noexcept
{
	...
	SetAppID(_T("MFCDrawer.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFCDrawerApp

CMFCDrawerApp theApp;


// Инициализация CMFCDrawerApp

BOOL CMFCDrawerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMFCDrawerDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMFCDrawerView));
	if (!pDocTemplate)
		return FALSE;
...
int CMFCDrawerApp::ExitInstance()
{
...
// Обработчики сообщений CMFCDrawerApp
